...
public class SelectionPane extends JPanel{
	...
	public SelectionPane(MainUI main) {
		...
		btnTitlePage.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				String mediaPath = Operation.getOpenedFile();
				if (mediaPath.equals("")) {
					//nothing
				} else {
				CreateTitleCreditFrame titleFrame = new CreateTitleCreditFrame(mediaPath, "Create Title page(s)");
				}
			}
		});
		...
		btnAddCreditPage.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				String mediaPath = Operation.getOpenedFile();
				if (mediaPath.equals("")) {
				...
				CreateTitleCreditFrame creditFrame = new CreateTitleCreditFrame(mediaPath, "Create Credit page(s)");
				}
			}
		});
